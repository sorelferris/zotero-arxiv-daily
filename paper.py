...
class ArxivPaper:
    ...
    def tldr(self) -> str:
        ...
        prompt = (
            ...
            "no restriction on the number of sentences; make sure to include the complete context with details, "
            "and focus on precision and completeness to fully reflect the essence of the paper."
